	...
	return (
		<View style={styles.mainContainer}>
			<TouchableOpacity
				...
				onPress={() =>
					alert('Etes vous sur de vous déconnecter ?')
				} /*TODO : redirection Login if yes*/
			>
			...
			<Card containerStyle={styles.defaultCard}>
				...
				<View style={styles.buttonContainer}>
					<TouchableOpacity
						style={styles.basicButton}
						onPress={() =>
							alert('Redirection to formulaire')
						} /*TODO : redirection formulaire*/
					>
					...
					<TouchableOpacity
						style={styles.basicButton}
						onPress={() =>
							alert('Redirection to abonnement')
						} /*TODO : redirection abonnement*/
					>
